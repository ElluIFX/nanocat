...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install nanocat[matrix]"
    ) from e
...
from nanocat.config.paths import get_data_dir, get_media_dir
from nanocat.config.schema import Base
from nanocat.utils.helpers import safe_filename
